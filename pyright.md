...
- using a redundant module or symbol alias during the import, eg: `from . import box as box`. See [PEP 484](https://www.python.org/dev/peps/pep-0484/#stub-fil[es)and the example here in [rich #1596](https://github.com/willmcgugan/rich/pull/1596/files).
